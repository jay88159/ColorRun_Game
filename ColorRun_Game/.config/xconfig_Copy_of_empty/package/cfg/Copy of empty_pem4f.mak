...
package/cfg/Copy of empty_pem4f.oem4f: export C_DIR=
package/cfg/Copy of empty_pem4f.oem4f: PATH:=$(ti.targets.arm.elf.M4F.rootDir)/bin/;$(PATH)
package/cfg/Copy of empty_pem4f.oem4f: Path:=$(ti.targets.arm.elf.M4F.rootDir)/bin/;$(PATH)

package/cfg/Copy of empty_pem4f.sem4f: | .interfaces
package/cfg/Copy of empty_pem4f.sem4f: package/cfg/Copy of empty_pem4f.c package/cfg/Copy of empty_pem4f.mak
	@$(RM) $@.dep
	$(RM) $@
	@$(MSG) clem4f -n $< ...
	$(ti.targets.arm.elf.M4F.rootDir)/bin/armcl -c -n -s --symdebug:none "-mv7M4 --code_state=16 --float_support=FPv4SPD16 --abi=eabi -me --include_path=\"c:/ti/ccsv6/tools/compiler/arm_5.1.6/include\" --include_path=\"C:/ti/tirtos_tivac_2_10_01_38/products/TivaWare_C_Series-2.1.0.12573c\" -g --gcc --define=ccs=\"ccs\" --define=PART_TM4C123GH6PM --define=ccs --define=TIVAWARE --display_error_number --diag_warning=225 --diag_wrap=off --gen_func_subsections=on  " -qq -pdsw225 --endian=little -mv7M4 --abi=eabi --float_support=fpv4spd16 -eo.oem4f -ea.sem4f   -Dxdc_cfg__xheader__='"xconfig_Copy_of_empty/package/cfg/Copy of empty_pem4f.h"'  -Dxdc_target_name__=M4F -Dxdc_target_types__=ti/targets/arm/elf/std.h -Dxdc_bld__profile_release -Dxdc_bld__vers_1_0_5_1_6 -O2  $(XDCINCS) -I$(ti.targets.arm.elf.M4F.rootDir)/include/rts -I$(ti.targets.arm.elf.M4F.rootDir)/include  -fs=./package/cfg -fr=./package/cfg -fc $<
...
package/cfg/Copy of empty_pem4f.sem4f: export C_DIR=
package/cfg/Copy of empty_pem4f.sem4f: PATH:=$(ti.targets.arm.elf.M4F.rootDir)/bin/;$(PATH)
package/cfg/Copy of empty_pem4f.sem4f: Path:=$(ti.targets.arm.elf.M4F.rootDir)/bin/;$(PATH)

clean,em4f ::
	-$(RM) package/cfg/Copy of empty_pem4f.oem4f
	-$(RM) package/cfg/Copy of empty_pem4f.sem4f

Copy of empty.pem4f: package/cfg/Copy of empty_pem4f.oem4f package/cfg/Copy of empty_pem4f.mak

clean::
	-$(RM) package/cfg/Copy of empty_pem4f.mak
