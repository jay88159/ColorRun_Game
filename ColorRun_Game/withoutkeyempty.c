...
/*
#define NUM_OF_PER_ROW        4
#define NUM_OF_PER_COLLOM     4
const int16_t BounderOfNumbers[NUM_OF_PER_ROW][NUM_OF_PER_COLLOM]={
		{},{},
};*/
/**
 * Test here
...
//    USBCDCD_init();
    ...
    consoleTaskParams.stackSize = 1556;
    ...
    grlibTaskParams.stackSize = 1556;
